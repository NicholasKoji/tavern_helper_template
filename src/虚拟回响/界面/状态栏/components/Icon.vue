...
const icons = {
  ...
  list: '<path d="M8 6h13"/><path d="M8 12h13"/><path d="M8 18h13"/><path d="m3 6 1 1 2-2"/><path d="m3 12 1 1 2-2"/><path d="m3 18 1 1 2-2"/>',
  map: '<path d="M14.5 4.5 9.5 2 3 5.5v16l6.5-3 5 2.5 6.5-3.5v-16z"/><path d="M9.5 2v16.5"/><path d="M14.5 4.5V21"/>',
  mapPin:
  ...
  shield:
    '<path d="M20 13c0 5-3.5 7.5-7.4 8.9a2 2 0 0 1-1.2 0C7.5 20.5 4 18 4 13V6a2 2 0 0 1 1.2-1.8l6-2.2a2 2 0 0 1 1.6 0l6 2.2A2 2 0 0 1 20 6z"/>',
...
const path = computed(() => icons[props.name] ?? icons.box);
</script>
